...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LSM_INT2_Pin|LSM_NCS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LSM_INT1_Pin|MS5_NCS_Pin|ICM_NCS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LSM_INT1_Pin MS5_NCS_Pin ICM_NCS_Pin */
  GPIO_InitStruct.Pin = LSM_INT1_Pin|MS5_NCS_Pin|ICM_NCS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
